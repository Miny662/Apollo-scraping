...
const jsonFilePath = 'apollo_response_2025-08-19T00-34-33-413Z.json';

try {
  const rawData = fs.readFileSync(jsonFilePath, 'utf8');
  const apolloData = JSON.parse(rawData);
  
  console.log(`📋 Processing data from: ${jsonFilePath}`);
  ...
  const outputFilename = `extracted_data_${timestamp}.json`;
